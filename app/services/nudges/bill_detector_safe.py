...
_safe_bill_detector = None


def get_safe_bill_detector() -> SafeBillDetector:
    global _safe_bill_detector
    if _safe_bill_detector is None:
        _safe_bill_detector = SafeBillDetector()
    return _safe_bill_detector
