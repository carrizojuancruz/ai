...
class StrategyRegistry:
    ...
    def _register_defaults(self):
        ...
        logger.info("strategy_registry.defaults_registered", strategies=list(self._strategy_classes.keys()))
    ...
    def register_strategy_class(self, nudge_type: str, strategy_class: Type[NudgeStrategy]):
        ...
        logger.info("strategy_registry.class_registered", nudge_type=nudge_type, strategy_class=strategy_class.__name__)
    ...
    def get_strategy(self, nudge_type: str) -> Optional[NudgeStrategy]:
        ...
        if not strategy_class:
            logger.warning(
                "strategy_registry.unknown_type",
        ...
        try:
            ...
            logger.info(
                "strategy_registry.strategy_created", nudge_type=nudge_type, strategy_class=strategy_class.__name__
            )
            return strategy
        except Exception as e:
            logger.error(
                "strategy_registry.instantiation_failed",
                nudge_type=nudge_type,
    ...
    def register_custom_strategy(self, strategy: NudgeStrategy):
        ...
        self._strategies[nudge_type] = strategy
        logger.info(
            "strategy_registry.custom_registered", nudge_type=nudge_type, strategy_class=strategy.__class__.__name__
        )
