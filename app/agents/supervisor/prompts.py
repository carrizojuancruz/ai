...
SUPERVISOR_PROMPT = """
    ...
    **IMPORTANT JSON FIELD POLICY:**
    ...
    Example E — Route to goal_agent for financial goals management (PRIORITY ROUTING)
    ...
    Example F — Route to goal_agent for goal modification
    ...
    Example G — Route to goal_agent for goal status check
