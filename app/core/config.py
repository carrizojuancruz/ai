...
class Config:
    ...
    MEMORY_COLD_PATH_MAX_WORKERS: int = int(os.getenv("MEMORY_COLD_PATH_MAX_WORKERS"))
    MEMORY_COLD_PATH_MAX_RETRIES: int = int(os.getenv("MEMORY_COLD_PATH_MAX_RETRIES"))
    MEMORY_COLD_PATH_RETRY_BACKOFF_SECONDS: float = float(os.getenv("MEMORY_COLD_PATH_RETRY_BACKOFF_SECONDS"))
    MEMORY_COLD_PATH_THREAD_STATE_TTL_SECONDS: int = int(os.getenv("MEMORY_COLD_PATH_THREAD_STATE_TTL_SECONDS"))
    MEMORY_COLD_PATH_THREAD_STATE_CLEANUP_INTERVAL_SECONDS: int = int(os.getenv("MEMORY_COLD_PATH_THREAD_STATE_CLEANUP_INTERVAL_SECONDS"))
